...
<head>
    ...
    <title>Tambah Kasir - Vortex Mart</title>
    <style>
        /* Basic Reset */
        * {
            margin: 0;
...
<body>
    ...
    <div class="container">
        ...
        <h2 class="title">Tambah Kasir</h2>
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input type="number" name="teleponKasir" required>
            </div>
            <div class="form-group">
        ...
        if (isset($_POST['submit'])) {
            ...
            // Insert new data
            $query = "INSERT INTO kasir (namaKasir, teleponKasir, userKasir, password) VALUES ('$namaKasir', '$teleponKasir', '$userKasir', '$password')";
